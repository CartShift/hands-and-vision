...
<section class="hv-section <?php echo esc_attr( $section_class ); ?>">
	...
	<div class="hv-masonry-grid hv-stagger">
		...
		?>
			<article class="hv-masonry-grid-item hv-reveal">
				<?php if ( $has_overlay ) : ?>
		...
		<?php else : ?>
			<article class="hv-masonry-grid-item hv-reveal">
				<a href="<?php echo esc_url( $item['url'] ); ?>" class="hv-lightbox" data-caption="<?php echo esc_attr( $item['caption'] ?? '' ); ?>">
					<img src="<?php echo esc_url( $item['src'] ?? $item['url'] ); ?>" alt="<?php echo esc_attr( $item['alt'] ?? '' ); ?>" loading="lazy">
				</a>
			</article>
