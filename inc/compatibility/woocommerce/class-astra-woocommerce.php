...
if ( ! class_exists( 'Astra_Woocommerce' ) ) {
	...
	class Astra_Woocommerce {
		...
		public function single_product_customization() {
			...
			// Breadcrumb - Removed default WooCommerce breadcrumb (using custom breadcrumbs instead)
			remove_action( 'woocommerce_before_main_content', 'woocommerce_breadcrumb', 20, 0 );
			// Removed: add_action( 'woocommerce_single_product_summary', 'woocommerce_breadcrumb', 2 );
		}
